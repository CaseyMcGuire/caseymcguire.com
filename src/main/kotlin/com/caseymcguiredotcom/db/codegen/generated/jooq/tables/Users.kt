...
open class Users(
    ...
    fun posts(): PostsPath {
        if (!this::_posts.isInitialized)
            _posts = PostsPath(this, null, POSTS__FK_ID.inverseKey)
    ...
    /**
     * Get the implicit to-many join path to the <code>public.workout</code>
     * table
     */
    fun workout(): WorkoutPath {
        if (!this::_workout.isInitialized)
            _workout = WorkoutPath(this, null, WORKOUT__FK_USER.inverseKey)
    ...
    fun wikiUsers(): WikiUsersPath {
        if (!this::_wikiUsers.isInitialized)
            _wikiUsers = WikiUsersPath(this, null, WIKI_USERS__FK_WIKI_USERS_USER_ID__ID.inverseKey)
    ...
    /**
     * Get the implicit many-to-many join path to the <code>public.wikis</code>
     * table
     */
    val wikis: WikisPath
        get(): WikisPath = wikiUsers().wikis()
