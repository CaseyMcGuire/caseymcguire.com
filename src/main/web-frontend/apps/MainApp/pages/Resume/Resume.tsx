import EducationCard from "apps/MainApp/pages/Resume/components/EducationCard";
import Section from "apps/MainApp/pages/Resume/components/Section";
import TechnologyInfoCard from "apps/MainApp/pages/Resume/components/TechnologyInfoCard";
import EmploymentCard from "apps/MainApp/pages/Resume/components/EmploymentCard";
